...
리뷰 후 2026-09-13 회의에서 전사 문장의 LLM 교정·재작성을 제외하기로 합의했다.
Q&A·근거 검증·면접 요약은 유지한다. [회의 결정](stt-pipeline.md#2026-09-13-ai-회의-결정-전사-교정-제외)은
문서에 반영했으며 이 보완으로 코드·테스트·기존 벤치마크 원본은 바꾸지 않았다.
